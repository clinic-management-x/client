...
const TopBar = () => {
  ...
  return (
    <div className="fixed z-[9999] top-0 border-gray-300 dark:border-black bg-white dark:bg-black border-b-2 grid-rows-3 flex justify-between items-center  w-full h-[70px]">
